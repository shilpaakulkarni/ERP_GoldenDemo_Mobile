...
}(window,document,"Bots", "https://stormy-caverns-54710.herokuapp.com/bots-client-sdk-js");
...
function loadChat(e){
    ...
    var appId = '5cd90fc6656b360010115743';
    initBots('5cd90fc6656b360010115743')
        .then(function () {
...
function clearChat(e){
    ...
    for(var i = 0; i < keys.length; i++){
        if(keys[i] === '5cd90fc6656b360010115743'){
            continue;
        }
...
function initBots(appId){
    return Bots.init({
        ...
        customText: {
            ...
            headerText: 'Oracle Digital Assistant',
            // inputPlaceholder: 'Type a message...',
            // invalidFileError: 'Only images are supported. Choose a file with a supported extension (jpg, jpeg, png, gif, or bmp).',
            introductionText: 'Oracle Digital Assistant 4 SaaS',
